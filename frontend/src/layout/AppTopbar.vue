                ...
                <div class="layout-topbar-menu-content">
                    ...
                    <OverlayPanel ref="profile" id="overlay_profile_menu" class="m-0 p-0" style="padding: 0">
                        <Menu :model="items" class="w-full md:w-[16rem] border-none shadow-none p-0">
                            <template #start>
                                <div class="flex flex-col items-center justify-center pt-5 pb-3 px-4 border-b border-surface-200 dark:border-surface-700 mb-2">
                                    <Avatar :label="userInitials" class="mb-3 bg-primary text-primary-contrast text-xl" size="xlarge" shape="circle" />

                                    <span class="font-bold text-lg text-surface-900 dark:text-surface-0 text-center"> {{ authStore.userName }} </span>
                                    <span class="text-sm text-surface-500 dark:text-surface-400 text-center mt-1"> {{ authStore.user?.email }} </span>

                                    <span class="mt-2 px-2 py-1 bg-surface-100 dark:bg-surface-800 text-xs rounded-md text-surface-600 dark:text-surface-300"> Admin </span>
                                </div>
                            </template>

                            <template #item="{ item, props }">
                                <a v-ripple class="flex items-center p-3 text-surface-700 dark:text-surface-0 hover:bg-surface-100 dark:hover:bg-surface-800 cursor-pointer transition-colors" v-bind="props.action">
                                    <span :class="item.icon" class="mr-3 text-primary" />
