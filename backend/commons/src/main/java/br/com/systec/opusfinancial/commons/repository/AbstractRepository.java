package br.com.systec.opusfinancial.commons.repository;
...
@NoRepositoryBean
public abstract class AbstractRepository<T, J> implements CrudRepository<T, J> {
    ...
    public @NonNull Optional<T> findById(@NonNull J id) {
        T entity = entityManager.find(entityClass, id);
        return Optional.ofNullable(entity);
    }

    private Optional<T> findByIdPrivate(J id) {
        T entity = entityManager.find(entityClass, id);
        return Optional.ofNullable(entity);
    }
    ...
    @Override
    @Transactional(propagation = Propagation.SUPPORTS)
    public boolean existsById(@NonNull J id) {
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    @NonNull
    public Iterable<T> findAllById(Iterable<J> ids) {
    ...
    @Override
    @Transactional(propagation = Propagation.REQUIRED)
    public void deleteById(@NonNull J id) {
    ...
    @Override
    public void deleteAllById(Iterable<? extends J> iterable) {
    ...
    @Transactional(propagation = Propagation.SUPPORTS)
    public T findByIdOrNull(@NonNull J id) {
        Optional<T> entity = findByIdPrivate(id);
