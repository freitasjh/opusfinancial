...
public class FinancialTransactionMapper {
    ...
    public static FinancialTransactionMapper of() {
        return new FinancialTransactionMapper();
    }

    public FinancialTransaction toEntity(FinancialTransactionVO transactionVO, TransactionType transactionType, CategoryTransactionType categoryTransactionType) {
