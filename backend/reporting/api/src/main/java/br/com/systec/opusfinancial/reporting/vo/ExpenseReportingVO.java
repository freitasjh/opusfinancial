...
public class ExpenseReportingVO implements Serializable {
    ...
    public ExpenseReportingVO(Tuple tuple) {
        ...
        this.dueDate = DateUtils.dateSqlToLocalDate(tuple.get("expense_due_date", Date.class));
        ...
        this.processed = tuple.get("expense_processed", Boolean.class);
    }
